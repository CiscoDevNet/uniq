...
class IwannetworkdeviceApi(object):
    ...
    def validateDeviceForBrownfieldConfiguration(self, **kwargs):
        ...
        Args:
            ...
            isGreenFieldDevice, str: isGreenFieldDevice (required)
        ...
        allParams = ['ipAddress', 'isExternalMasterController', 'siteType', 'lanInterface', 'wanInterface', 'isGreenFieldDevice', 'username', 'scope']
        ...
        if ('isGreenFieldDevice' in params):
            queryParams['isGreenFieldDevice'] = self.apiClient.toPathValue(params['isGreenFieldDevice'])
