...
class PnpprojectApi(object):
    ...
    def getPnpSiteByRange(self, **kwargs):
        ...
        Args:
            ...
            state, str: State of a project. Allowed states are PRE_PROVISIONED,IN_PROGRESS,ERROR,ls. (required)
    ...
    def importPnpSitesAndDevices(self, **kwargs):
        ...
        if ('seedFile' in params):
            files['seedFile'] = params['seedFile']
    ...
    def getPnpSiteDevicesBySiteNameAndRange(self, **kwargs):
        ...
        Args:
            ...
            state, str: State of device. PENDING, PROVISIONED, IN_PROGRES, ERROR. Accepts a list of states (required)
        ...
        allParams = ['projectId', 'serialNumber', 'productId', 'hostName', 'configId', 'templateConfigId', 'imageId', 'pkiEnabled', 'state', 'authStatus', 'startLastStateTransitionTime', 'endLastStateTransitionTime', 'sortBy', 'order', 'offset', 'limit', 'scope']
    ...
    def getPnpSiteDeviceCount(self, **kwargs):
        ...
        allParams = ['projectId', 'serialNumber', 'productId', 'hostName', 'configId', 'templateConfigId', 'imageId', 'pkiEnabled', 'state', 'authStatus', 'startLastStateTransitionTime', 'endLastStateTransitionTime', 'scope']
